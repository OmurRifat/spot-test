...
const PrivateRoute = ({ children }) => {
    ...
    if (loading) {
        return <div className='text-center' role="status">
            <svg className="inline mr-2 w-10 h-10 text-gray-200 animate-spin dark:text-gray-600 fill-purple-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
